...
template class Multiply<bool>;
template class Multiply<short>;
template class Multiply<unsigned short>;
template class Multiply<int>;
template class Multiply<unsigned int>;
template class Multiply<long>;
template class Multiply<unsigned long>;
template class Multiply<long long>;
template class Multiply<unsigned long long>;
template class Multiply<float>;
template class Multiply<double>;
template class Multiply<long double>;
template class Divide<bool>;
template class Divide<short>;
template class Divide<unsigned short>;
template class Divide<int>;
template class Divide<unsigned int>;
template class Divide<long>;
template class Divide<unsigned long>;
template class Divide<long long>;
template class Divide<unsigned long long>;
template class Divide<float>;
template class Divide<double>;
template class Divide<long double>;
...
template class Rectifier<bool>;
template class Rectifier<short>;
template class Rectifier<unsigned short>;
template class Rectifier<int>;
template class Rectifier<unsigned int>;
template class Rectifier<long>;
template class Rectifier<unsigned long>;
template class Rectifier<long long>;
template class Rectifier<unsigned long long>;
template class Rectifier<float>;
template class Rectifier<double>;
template class Rectifier<long double>;
template class Log<bool>;
template class Log<short>;
template class Log<unsigned short>;
template class Log<int>;
template class Log<unsigned int>;
template class Log<long>;
template class Log<unsigned long>;
template class Log<long long>;
template class Log<unsigned long long>;
template class Log<float>;
template class Log<double>;
template class Log<long double>;
