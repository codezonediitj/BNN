...
template class ReLU<bool>;
template class ReLU<short>;
template class ReLU<unsigned short>;
template class ReLU<int>;
template class ReLU<unsigned int>;
template class ReLU<long>;
template class ReLU<unsigned long>;
template class ReLU<long long>;
template class ReLU<unsigned long long>;
template class ReLU<float>;
template class ReLU<double>;
template class ReLU<long double>;
